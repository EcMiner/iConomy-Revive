...
public class Database {
    ...
    public Connection getConnection() throws SQLException {
        if (driver.equals("org.sqlite.JDBC")) {
            if (Constants.Nodes.DatabaseLocalSqlite.getBoolean())
                return DriverManager.getConnection("jdbc:sqlite:" + new File(iConomy.directory, "accounts.sqlite").getAbsolutePath());
        }
