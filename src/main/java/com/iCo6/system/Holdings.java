...
public class Holdings {
    ...
    public Holdings(UUID uuid) {
        this.uuid = uuid;
    }

    public Double getBalance() {
        return Queried.getBalance(this.uuid);
    }

    public void setBalance(double balance) {
        Queried.setBalance(this.uuid, balance);
    }
    ...
    public void showBalance(CommandSender to) {
        if (to != null) {
            ...
            template.add("name", Bukkit.getPlayer(uuid) != null ? Bukkit.getPlayer(uuid).getName() : Bukkit.getOfflinePlayer(uuid).getName());
    ...
    private void math(double amount, double balance, double ending) {
        HoldingsUpdate Event = new HoldingsUpdate(this.uuid, balance, ending, amount);
